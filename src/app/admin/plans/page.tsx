...
export default function PlansPage() {
    ...
    setTimeout(() => {
      const dummyPlans: Plan[] = [
        ...
        },
        {
          ...
          maxUsers: 25,
          maxStorage: 1000,
          features: ['Full CRM', '25 Users', '1GB Storage', 'Priority Support', 'AI Chat'],
          isActive: true,
          isPopular: true,
          subscriberCount: 89,
        ...
        },
        {
          ...
          maxUsers: 100,
          maxStorage: 5000,
          features: ['Full CRM', '100 Users', '5GB Storage', 'Priority Support', 'AI Chat', 'Advanced Analytics', 'API Access'],
          isActive: true,
          isPopular: false,
          subscriberCount: 34,
        ...
        },
        {
          ...
          maxUsers: 1000,
          maxStorage: 50000,
          features: ['Full CRM', 'Unlimited Users', '50GB Storage', '24/7 Support', 'AI Chat', 'Advanced Analytics', 'API Access', 'Custom Integrations', 'Dedicated Account Manager'],
          isActive: true,
          isPopular: false,
          subscriberCount: 12,
  ...
  useEffect(() => {
    ...
    if (filterStatus !== 'all') {
      filtered = filtered.filter(plan =>
        filterStatus === 'active' ? plan.isActive : !plan.isActive
      );
    }
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredPlans.map((plan) => (
              <div key={plan.id} className={`bg-gray-800 rounded-lg p-6 border ${plan.isPopular ? 'border-blue-500' : 'border-gray-700'} hover:border-gray-600 transition-colors relative`}>
                {plan.isPopular && (
                ...
                <div className="space-y-3 mb-4">
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <span className="text-white font-medium">{plan.maxUsers === 1000 ? 'Unlimited' : plan.maxUsers}</span>
                  </div>
                  <div className="flex items-center justify-between text-sm">
                    <span className="text-gray-400">Storage:</span>
                    <span className="text-white font-medium">{plan.maxStorage}MB</span>
                  </div>
                  <div className="flex items-center justify-between text-sm">
          ...
          {filteredPlans.length === 0 && (
            <div className="text-center py-12">
              ...
              <h3 className="text-lg font-semibold text-white mt-4">No plans found</h3>
            ...
            <div className="bg-gray-800 rounded-lg p-4 border border-gray-700">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-white">{plans.reduce((total, plan) => total + plan.subscriberCount, 0)}</p>
                </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-white">
                    {formatCurrency(
                      plans.reduce((total, plan) => total + (plan.price * plan.subscriberCount), 0),
                      'IDR'
                    )}
                  </p>
                </div>
