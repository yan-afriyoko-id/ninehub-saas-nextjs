      ...
      const dummyRoles: Role[] = [
        {
          ...
          permissions: ['user.view', 'user.create', 'user.edit', 'user.delete', 'tenant.view', 'tenant.create', 'tenant.edit', 'tenant.delete', 'plan.view', 'plan.create', 'plan.edit', 'plan.delete'],
          isActive: true,
          userCount: 2,
        ...
        },
        {
          ...
          permissions: ['user.view', 'user.create', 'user.edit', 'tenant.view', 'tenant.create', 'plan.view'],
          isActive: true,
          userCount: 5,
        ...
        },
        {
          ...
          permissions: ['crm.view', 'crm.create', 'crm.edit', 'chat.send', 'chat.history'],
          isActive: true,
          userCount: 45,
        ...
        <div className="space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-400">Manage user roles and their permissions</p>
            </div>
            <button
          ...
          <div className="flex items-center space-x-4">
            ...
            <select
              value={filterGuard}
              onChange={(e) => setFilterGuard(e.target.value as any)}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredRoles.map((role) => (
              <div key={role.id} className="bg-gray-800 rounded-lg p-6 border border-gray-700 hover:border-gray-600 transition-colors">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <span className={`${role.isActive ? 'text-green-500' : 'text-red-500'}`}>
                ...
                <div className="mt-4 pt-4 border-t border-gray-700">
                  ...
                  <div className="flex flex-wrap gap-1">
                    {role.permissions.slice(0, 3).map((permission, index) => (
                      <span key={index} className="inline-flex items-center px-2 py-1 rounded-full text-xs bg-blue-900/20 text-blue-400 border border-blue-500/20">
          ...
          {filteredRoles.length === 0 && (
            <div className="text-center py-12">
              ...
              <h3 className="text-lg font-semibold text-white mt-4">No roles found</h3>
            ...
            <div className="bg-gray-800 rounded-lg p-4 border border-gray-700">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-white">{roles.reduce((total, role) => total + role.userCount, 0)}</p>
                </div>
