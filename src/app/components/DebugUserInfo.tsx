      ...
      <div className="mb-4">
        ...
        <div className="bg-gray-900 rounded p-3 text-sm">
          <p>
            ...
            <span className={isUserAdmin ? "text-green-400" : "text-red-400"}>
              {isUserAdmin ? "Yes" : "No"}
            </span>
          </p>
          <p>
            <span className="text-gray-400">Admin Roles:</span>{" "}
            <span className="text-white">
              [&apos;admin&apos;, &apos;super-admin&apos;]
            </span>
          </p>
      ...
      <div className="mb-4">
        ...
        <div className="bg-gray-900 rounded p-3 text-sm">
          <p>
            ...
            <span className="text-white">{allMenuItems.length}</span>
          </p>
          <p>
            <span className="text-gray-400">Admin Menu Items:</span>{" "}
            <span className="text-white">{adminMenuItems.length}</span>
          </p>
          <p>
            <span className="text-gray-400">User Menu Items:</span>{" "}
            <span className="text-white">{userMenuItems.length}</span>
          </p>
        </div>
      </div>
          ...
          {allMenuItems.map((item) => (
            <div key={item.id} className="mb-2 p-2 bg-gray-800 rounded">
              ...
              <p>
                ...
                <span className="text-white">{getMenuItemPath(item)}</span>
              </p>
              <p>
                <span className="text-gray-400">Permission:</span>{" "}
                <span className="text-white">{item.permission || "None"}</span>
              </p>
              <p>
                <span className="text-gray-400">Roles:</span>{" "}
                <span className="text-white">
              ...
              <p>
                <span className="text-gray-400">Is Admin:</span>{" "}
                <span
                  className={item.isAdmin ? "text-green-400" : "text-red-400"}
                >
                  {item.isAdmin ? "Yes" : "No"}
                </span>
              </p>
