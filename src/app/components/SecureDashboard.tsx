...
export default function SecureDashboard({ children }: SecureDashboardProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-900 flex">
      ...
      {/* Sidebar */}
      <div className={`fixed lg:static inset-y-0 left-0 z-50 w-64 bg-gray-800 border-r border-gray-700 transform transition-transform duration-300 ease-in-out ${
        ...
        <div className="p-6">
          ...
          <div className="flex items-center justify-between mb-8 lg:hidden">
            <div className="flex items-center space-x-3">
              <div className={`p-2 rounded-lg ${isUserAdmin ? 'bg-blue-600' : 'bg-green-600'}`}>
                {isUserAdmin ? <Shield size={20} className="text-white" /> : <Building size={20} className="text-white" />}
              </div>
              <div>
