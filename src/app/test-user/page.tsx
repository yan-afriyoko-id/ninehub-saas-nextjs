  ...
  return (
    <div className="min-h-screen bg-gray-900 p-6">
      <div className="max-w-6xl mx-auto space-y-6">
        <h1 className="text-3xl font-bold text-white mb-6">🔍 User Data Test Page</h1>
        ...
        {rawApiData && (
          <div className="bg-gray-800 border border-gray-700 rounded-lg p-4">
            ...
            <div className="bg-gray-900 rounded p-3 text-sm overflow-auto">
              <pre className="text-green-400">{JSON.stringify(rawApiData, null, 2)}</pre>
            </div>
          </div>
        )}
        ...
        <div className="bg-gray-800 border border-gray-700 rounded-lg p-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-gray-900 rounded p-3">
              <h4 className="text-blue-400 font-medium mb-2">Admin Menu Items ({adminMenuItems.length})</h4>
              <div className="space-y-1 text-sm">
                {adminMenuItems.map((item) => (
                  <div key={item.id} className="text-white p-2 bg-gray-800 rounded">
            ...
            <div className="bg-gray-900 rounded p-3">
              <h4 className="text-green-400 font-medium mb-2">User Menu Items ({userMenuItems.length})</h4>
              <div className="space-y-1 text-sm">
            ...
            <div className="bg-gray-900 rounded p-3">
              <h4 className="text-yellow-400 font-medium mb-2">All Menu Items ({allMenuItems.length})</h4>
              <div className="space-y-1 text-sm">
        ...
        <div className="bg-blue-900/20 border border-blue-500/20 rounded-lg p-4">
          <h3 className="text-blue-400 font-semibold mb-4">🔧 Troubleshooting Guide:</h3>
          <div className="space-y-2 text-sm">
            <p className="text-blue-300">
              <strong>If menu items are missing:</strong>
            </p>
            <ul className="list-disc list-inside text-blue-300 ml-4 space-y-1">
              <li>Check if user has role 'admin' or 'super-admin'</li>
